...
public class FileUtil {
	...
	public final static String STD_ENCODING = "UTF-8";
	...
	public static void writeFileContent(String fileName,
			InputStream inputStream, String charEncoding) throws Exception {
		byte buf[] = new byte[1024];
		int len;
	...
	public static void appendFileContent(String fileName, String content,
		...
		try {
			bw = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream(fileName, true), charEncoding));
			bw.write(content);
		} catch (Exception e) {
			System.err.println("error trying to get file content"
					+ e.toString());
	...
	public static void appendFileContentTop(String fileName, String content,
			String charEncoding) throws Exception {
		try {
			if (!existFile(fileName))
				new File(fileName).createNewFile();
			Vector<String> tmp = getFileLines(fileName, charEncoding);
			Vector<String> tmp2 = new Vector<String>();
			tmp2.add(content);
			for (String s : tmp)
				tmp2.add(s);
			writeFileContent(fileName, tmp2, charEncoding);
		} catch (Exception e) {
			System.err.println("error trying to get file content"
					+ e.toString());
			// e.printStackTrace();
	...
	/**
	 * Write to a file, overwriting contents.
	 * 
	 * @param f
	 * @param content
	 * @param charEncoding
	...
	/**
	 * Write to a file, appending contents.
	 * 
	 * @param f
	 * @param content
	 * @param charEncoding
	 * @throws Exception
	 */
	public static void appendFileContent(File f, String content,
			String charEncoding) throws Exception {
		appendFileContent(f.getAbsolutePath(), content, charEncoding);
	}

	public static void appendFileContentTop(File f, String content,
			String charEncoding) throws Exception {
		appendFileContentTop(f.getAbsolutePath(), content, charEncoding);
	}
	...
	/**
	 * Retrieve all word tokens from a file, irrespective of lines.
	 * 
	 * @param inputStream
	 *            The input.
	 * @param charEncoding
	 ...
	 * @throws Exception
	 */
	public static String[] getTokensFromStream(InputStream inputStream,
			String charEncoding) throws Exception {
		BufferedReader input = null;
		Vector<String> ret = new Vector<String>();
		// use buffering, reading one line at a time
	 ...
	 * @throws Exception
	 */
	public static String[] getTokensFromFileName(String fileName,
			String charEncoding) throws Exception {
		return getTokensFromStream(new FileInputStream(new File(fileName)),
				charEncoding);
	}
	...
	public static void main(String[] args) {
		try {
			String[] test = getTokensFromFileName("testfile", "UTF-8");
			StringUtil.printOutArray(test);
		} catch (Exception e) {
			e.printStackTrace();
		}
